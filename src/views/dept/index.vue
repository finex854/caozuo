  ...
  <div style="margin-top: 20px; margin: 50px; margin-right: 100px">
    ...
    <template>
      ...
      >
        ...
        <el-table-column prop="name" label="部门名称" header-align="center" align="center" />
    ...
    <el-dialog title="保存部门" :visible.sync="dialogFormVisible">
      <el-form :model="dept">
        <el-form-item label="部门名称" :label-width="formLabelWidth">
          <el-input v-model="dept.name" placeholder="请输入部门名称" autocomplete="off" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  mounted() {
    // 当页面加载完成后自动执行。
    this.init()
    // 假设role信息在本地存储或通过API获取，这里以本地存储为例
    // 若实际为API返回，请根据实际情况调整
